...
define("VERSION", "CRUD version 2.1.2 for SQLite");
define("DBENGINE", "sqlite3");

// for SQLite
define("DBFILE", "/Users/hasan_azimi0/Sites/phpLiteAdmin/db/album.db");
...
// get_album_length for SQLite 3 only
function get_album_length($id)
{
    global $CRUD;
    if(DBENGINE != 'sqlite3') return NULL;
    $dbh = $CRUD['dbh'];
